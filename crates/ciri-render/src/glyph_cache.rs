...
impl GlyphCache {
    ...
    pub fn new(
        ...
        // Bypasses crossfont's abstraction to get raw ascent/descent/line_gap
        // for proper vertical centering (ghostty approach).
...
fn compute_ft_metrics(face: &mut freetype::Face, pixel_size: f32) -> (f32, f32, f32, f32) {
