...
const ADJECTIVES: &[&str] = &[
    "aged", "bold", "brave", "brief", "bright", "calm", "clean", "clear",
    "cold", "cool", "crisp", "dark", "deep", "dry", "early", "fair",
    "fast", "firm", "flat", "free", "fresh", "full", "glad", "gold",
    "grand", "gray", "green", "happy", "keen", "kind", "late", "lean",
    "light", "live", "long", "lost", "loud", "mild", "neat", "new",
    "nice", "odd", "old", "pale", "plain", "proud", "pure", "quick",
    "rare", "raw", "red", "rich", "ripe", "rough", "round", "rusty",
    "safe", "sharp", "short", "shy", "slim", "slow", "small", "smart",
    "soft", "solid", "stark", "steep", "still", "stout", "sweet", "swift",
    "tall", "tame", "thin", "tiny", "tough", "trim", "true", "vast",
    "vivid", "warm", "weak", "wet", "white", "whole", "wide", "wild",
    "wise", "worn", "young",
];

const ANIMALS: &[&str] = &[
    "ant", "ape", "bat", "bear", "bee", "bird", "boar", "bull", "calf",
    "cat", "clam", "cod", "colt", "cow", "crab", "crane", "crow", "cub",
    "deer", "dog", "dove", "duck", "eagle", "eel", "elk", "ewe", "fawn",
    "finch", "fish", "fly", "fox", "frog", "goat", "goose", "grouse",
    "gull", "hare", "hawk", "hen", "hog", "horse", "hound", "jay",
    "kit", "kite", "lark", "lion", "lynx", "mare", "mink", "mole",
    "moth", "mouse", "mule", "newt", "owl", "ox", "parrot", "perch",
    "pig", "pike", "pony", "pug", "quail", "ram", "rat", "raven",
    "robin", "seal", "shark", "sheep", "shrew", "slug", "snail", "snake",
    "sole", "squid", "stag", "stork", "swan", "toad", "trout", "tuna",
    "vole", "wasp", "whale", "wolf", "worm", "wren", "yak",
];
...
pub fn validate_name(name: &str) -> Result<(), String> {
    ...
    if !name.chars().all(|c| c.is_ascii_lowercase() || c.is_ascii_digit() || c == '-') {
        return Err("session name can only contain lowercase letters, digits, and hyphens".to_string());
    }
    Ok(())
}
