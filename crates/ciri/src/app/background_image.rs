//! Global background image loader.
//!
//! Decodes the user-configured `appearance.background_image` into RGBA8
//! bytes the GPU backends can upload directly. The texture upload +
//! fullscreen-quad draw lives in each backend (DX, GL, blade).
//!
...
/// Decoded RGBA8 image ready for `Renderer::set_background_image`.
...
/// Decode the configured background image from disk.
///
