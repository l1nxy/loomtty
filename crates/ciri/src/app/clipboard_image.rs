...
const TEMP_SUBDIR: &str = "ciritty-clipboard";
const FILENAME_PREFIX: &str = "ciritty-paste-";
...
mod tests {
    ...
    fn create_exclusive_appends_counter_on_collision() {
        ...
        assert_eq!(p1.file_name().unwrap(), "ciritty-paste-1700000000.png");
        assert_eq!(p2.file_name().unwrap(), "ciritty-paste-1700000000-1.png");
        assert_eq!(p3.file_name().unwrap(), "ciritty-paste-1700000000-2.png");
    }
