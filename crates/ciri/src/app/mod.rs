...
impl App {
    ...
    fn save_current_to_slot(&mut self) -> Option<ConnectionSlot> {
        ...
        Some(ConnectionSlot {
            ...
            view_offset_x: std::mem::replace(&mut self.view_offset_x, ViewOffset::new()),
            view_offset_y: std::mem::replace(&mut self.view_offset_y, ViewOffset::new()),
    ...
    fn restore_from_slot(&mut self, slot: ConnectionSlot) {
        ...
        self.view_offset_x = slot.view_offset_x;
        self.view_offset_y = slot.view_offset_y;
        self.col_widths = slot.col_widths;
        ...
        self.pane_anims = slot.pane_anims;
