use ciri_app::app::{ModalField, ModalKind, kept_set};
...
impl App {
    ...
    /// this, *then* set the field. The structural test in ciri-app
...
mod tests {
    ...
    use ciri_app::app::{ContextMenuParent, PendingPasteTarget};
    use ciri_config::config::CiriConfig;

    fn make() -> App {
        App::new(CiriConfig::default(), "test")
    }
