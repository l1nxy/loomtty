use loom_anim::anim_value::AnimValue;
use loom_anim::easing::EasingCurve;
use loom_anim::manager::{
    AnimConfig, AnimKind, CloseStyle, OpenStyle, PaneCloseConfig, PaneOpenConfig,
};
use loom_anim::spring::SpringParams;
use loom_config::config::{AnimationPreset, PaneOpenStyle};
use loom_protocol::message::BounceDirection;
