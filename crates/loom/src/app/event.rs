...
impl ApplicationHandler for App {
    fn new_events(&mut self, event_loop: &ActiveEventLoop, cause: StartCause) {
        ...
        // The motion_ticker tracks loom-ui chrome animations (banner dots,
    ...
    fn resumed(&mut self, event_loop: &ActiveEventLoop) {
        ...
        let (cache, atlas_gpu) = renderer
            .create_atlas(&loom_render::glyph_cache::FontInitParams {
                font_size_pt: self.core.config.font.size,
                dpi_scale,
                family_name: &self.core.config.font.family,
                ui_family_name: self
        ...
        let viewport = loom_protocol::codec::ClientHello {
