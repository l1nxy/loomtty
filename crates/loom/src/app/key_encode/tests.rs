...
const LEVEL1: u16 = loom_protocol::message::MODE_KITTY_KEYBOARD;
...
const LEVEL2: u16 = LEVEL1 | loom_protocol::message::MODE_KITTY_REPORT_EVENTS;
...
const LEVEL4: u16 = LEVEL1
    ...
    | loom_protocol::message::MODE_KITTY_REPORT_ALTERNATES
    | loom_protocol::message::MODE_KITTY_REPORT_ALL;
