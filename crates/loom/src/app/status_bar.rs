use loom_render::glyph_cache::{FontStyle, GlyphCache, GlyphEntry, GlyphInstance};
use loom_render::ui_shaper::{UiShapedGlyph, UiTextShaper};
...
mod tests {
    ...
    fn shaped_glyph_places_at_pen_with_offsets() {
        ...
        let inst = make_shaped_glyph_instance(
            ...
            &UiShapedGlyph {
                glyph_id: 1,
                font_id: loom_render::fontdb::ID::dummy(),
                x_advance: 8.0,
                x_offset: 0.5,
                y_offset: -1.0,
                cluster: 0,
