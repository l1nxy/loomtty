...
use loom_ui::{IntoElement, Render, RenderCtx, Styled, div, text};
...
impl TabBarComponent {
    ...
    fn build_hit_tree(&self, rect: UiRect, cx: &UiContext<'_>) -> loom_ui::Div {
    ...
    fn build_tree(&self, cx: &RenderCtx<'_>) -> loom_ui::Div {
        let rect = self.rect;
...
impl TabBarComponent {
    pub(crate) fn paint(&mut self, cx: &UiContext<'_>, scene: &mut UiScene<'_>) {
        ...
        // Sixth production usage of `loom_ui::Render`. The chrome
