...
pub fn run_init() -> Result<()> {
    ...
    println!("\n  Welcome to loomtty! Let's set up your configuration.\n");
...
fn generate_config(
    ...
    format!(
        r#"# Loomtty configuration — generated by `loomtty init`
#
# This wizard writes a minimal config. Every option, its default, and its valid
# range is documented in the full configuration reference:
#   https://linxy.dev/loomtty/reference/configuration
...
"shift+k" = "move_pane_up"
"shift+j" = "move_pane_down"
