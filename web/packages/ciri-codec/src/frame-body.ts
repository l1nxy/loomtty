...
// encoders in `crates/ciri-protocol/src/codec/{cell_delta,full_sync}.rs`
...
// callers (`@ciri/client.dispatchFrame`) must drop the connection on
 ...
 * past the last region. The caller (CiriClient) must drop the
