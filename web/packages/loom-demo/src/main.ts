// Demo entry point. Constructs a LoomApp against the dev bridge
...
//                         `loomtty`. The resolved name is then written
...
(window as unknown as { __loom?: LoomApp }).__loom = app;
